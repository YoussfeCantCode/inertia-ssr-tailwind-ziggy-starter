...
const Ziggy$1 = { "url": "http://localhost", "port": null, "defaults": {}, "routes": { "index": { "uri": "/", "methods": ["GET", "HEAD"] } } };
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: async (name) => {
      const page2 = (await resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Index.vue": () => import("./assets/Index-V_dDF6PP.js") }))).default;
      page2.layout = page2.layout || Layout;
      return page2;
    },
    setup({ App, props, plugin }) {
      return createSSRApp({
        render: () => h$1(App, props)
      }).use(k, Ziggy$1).component("Link", Link).component("Head", Head).use(plugin);
    }
  })
);
export {
